        ...
        <section className="relative border-b border-slate-800/80 bg-gradient-to-b from-[#0B1120] via-[#080C14] to-[#080C14] py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl space-y-6">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1 font-mono text-xs font-medium text-emerald-400">
                <Sparkles className="h-3.5 w-3.5 text-emerald-400" />
                <span>abiner.dev — Blog Pessoal & Engenharia</span>
              </div>

              {/* Title */}
              <h1 className="font-sans text-4xl sm:text-6xl font-extrabold tracking-tight leading-tight text-slate-100">
                Código, Curiosidade & <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Caos</span>.
              </h1>

              {/* Subtitle */}
              <p className="text-base sm:text-xl text-slate-400 leading-relaxed max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-2 pt-2 text-xs font-mono text-slate-400">
                <span className="flex items-center gap-1.5 rounded-md border border-slate-800 bg-slate-900 px-2.5 py-1">
                  <Code2 className="h-3.5 w-3.5 text-emerald-400" /> Golang
                </span>
                <span className="flex items-center gap-1.5 rounded-md border border-slate-800 bg-slate-900 px-2.5 py-1">
                  <Zap className="h-3.5 w-3.5 text-emerald-400" /> TypeScript & Next.js
                </span>
                <span className="flex items-center gap-1.5 rounded-md border border-slate-800 bg-slate-900 px-2.5 py-1">
                  <Cpu className="h-3.5 w-3.5 text-emerald-400" /> Linux Kernel
                </span>
                <span className="flex items-center gap-1.5 rounded-md border border-slate-800 bg-slate-900 px-2.5 py-1">
                  <ShieldCheck className="h-3.5 w-3.5 text-emerald-400" /> Segurança App
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                <div className="font-mono text-xs text-emerald-400 mb-2">#01 · GO CONCURRENCY</div>
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                <div className="font-mono text-xs text-emerald-400 mb-2">#02 · LINUX HISTORY</div>
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                <div className="font-mono text-xs text-emerald-400 mb-2">#03 · HTTP-ONLY COOKIES</div>
